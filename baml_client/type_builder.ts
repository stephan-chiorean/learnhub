...
export default class TypeBuilder {
    ...
    FileMetadata: ClassViewer<'FileMetadata', "filePath">;
    
    PlanSection: ClassViewer<'PlanSection', "section" | "description" | "files">;
    ...
    constructor() {
        this.tb = new _TypeBuilder({
          classes: new Set([
            "FileMetadata","PlanSection","Resume",
          ]),
          enums: new Set([
        ...
        this.FileMetadata = this.tb.classViewer("FileMetadata", [
          "filePath",
        ]);
        
        this.PlanSection = this.tb.classViewer("PlanSection", [
